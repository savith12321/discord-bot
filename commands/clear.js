module.exports = {
    ...
    async execute(message, args){
      ...
      if(!message.member.permissions.has("MANAGE_MESSAGES")) return message.reply("Don't wast your time bro **YOU DONT HAVE PERMS TO DO THAT IDIDOT**").then(m => m.delete(5000));
      try{
