...
module.exports = async (Discord, client, message) => {
    ...
    require('../../functions/logger')(Discord, client, `${message.author.username}#${message.author.discriminator} sent :- ${message.content} on ${message.guild.name}(${message.guild.id}) at <#!${message.channel.id}>`);
